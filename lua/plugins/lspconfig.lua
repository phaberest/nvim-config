return {
  { -- LSP Configuration & Plugins
    ...
    dependencies = {
      ...
      -- Php
      {
        ...
        cmd = { 'PhpActor' },
        keys = {
          { '<leader>rp', ':PhpActor context_menu<cr>', desc = 'PhpActor context menu' },
        },
        build = function()
    ...
    config = function()
      ...
      local servers = {
        volar = {
          ...
          filetypes = { 'vue', 'javascript' }, -- enable takeover mode for js files - https://github.com/johnsoncodehk/volar/discussions/471
          init_options = {
            typescript = {
  ...
  },
  {
    ...
    keys = {
      { '<leader>cn', '<cmd>Navbuddy<cr>', desc = 'Lsp Navigation' },
    },
  },
